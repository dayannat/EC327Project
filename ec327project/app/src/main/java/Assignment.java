...
/*Time until due still needs to be changed to provide an easier to read form of return data,
* mostly likely an int array.
 */
...
public class Assignment {
    ...
    }   //return array with {days, hours, minutes, seconds}
